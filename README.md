...
`audit_predictions` lays out a 10×10 grid of test digits, each titled `P:<predicted> /
A:<actual>` with a green ✓ or a red ✗. Scanning for the red marks is the fastest way to see
